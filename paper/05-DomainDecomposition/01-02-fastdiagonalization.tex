...
We instead compute the true inverse of a perturbed Laplacian, given by $\boldsymbol{\mathcal{K}} = \mathbf{K} + \epsilon \mathbf{I}$.
...
The subdomain interior solver can be provided from the same fast diagonalization of the element matrix.
