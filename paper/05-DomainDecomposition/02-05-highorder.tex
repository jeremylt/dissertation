...
Klawonn, Pavarino, and Rheinbach investigated the performance of BDDC and FETI-DP preconditioners for the two dimensional Poisson problem with discontinuous coefficients \cite{klawonn2008spectral}.
...
\begin{tabular}{l ccc ccc}
  ...
  $p = 8$   &  1.000  &   5.194  &   5.194  &  1.001  &   5.01  &   5.00  \\
  $p = 16$  &  1.000  &   7.756  &   7.756  &  1.001  &   7.62  &   7.61  \\
  $p = 32$  &  1.000  &  89.678  &  89.678  &  1.002  &  10.86  &  10.84  \\
  \bottomrule
\end{tabular}
\end{center}
