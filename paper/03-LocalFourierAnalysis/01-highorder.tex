...
In one dimension, the nodes on the left and right boundaries of the element correspond to the same Fourier mode due to periodicity, so we can compute the symbol matrix as
\begin{equation}
