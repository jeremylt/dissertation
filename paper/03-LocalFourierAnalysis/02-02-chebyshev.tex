...
Using Definition \ref{def:chebyshev_symbol}, in Figure \ref{fig:chebyshev_spectrum_1d} we see the spectrum of the symbol of third order Chebyshev polynomial smoothing for the 1D scalar diffusion operator and in \ref{fig:chebyshev_spectrum_2d} we see the spectral radius of the symbol of third order Chebyshev polynomial smoothing for the 2D scalar diffusion operator.
Again, in both cases we use a fourth-order H1 Lagrange finite element basis on the Gauss-Lobatto points.
