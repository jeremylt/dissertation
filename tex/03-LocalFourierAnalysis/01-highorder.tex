...
\end{bmatrix}
\end{equation}
where $L^{i, j}$, $i, j \in \left\lbrace 1, 2, \dots, p \right\rbrace$ is given by scalar Toeplitz operators describing how component $j$ appears in the equation for component $i$.
