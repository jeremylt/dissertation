...
\end{tabular}
\end{center}
\caption{LFA and Experimental Two-Grid Convergence Factor for $P$-Multigrid with Jacobi Smoothing for 3D Laplacian with $\omega = 1.0$}
...
\end{tabular}
\end{center}
\caption{LFA and Experimental Two-Grid Convergence Factor for $P$-Multigrid with Chebyshev Smoothing for 3D Laplacian}
