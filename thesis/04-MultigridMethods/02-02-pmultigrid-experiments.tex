...
\begin{figure}[!tbp]
  ...
  \caption{Two-Grid Analysis for $P$-Multigrid with Jacobi Smoothing for the 1D Laplacian}
\end{figure}
...
\begin{figure}[!tbp]
  ...
  \caption{Two-Grid Convergence for $P$-Multigrid with Jacobi Smoothing for the 2D Laplacian}
\end{figure}
