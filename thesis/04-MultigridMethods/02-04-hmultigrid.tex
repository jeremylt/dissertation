...
With macro-element bases, the grid transfer operators can be still represented elementwise and can thus be easily represented in the matrix-free form of Equation \ref{eq:libceed_representation}.
...
\begin{figure}[!ht]
  ...
  \caption{$H$-Prolongation from Coarse Basis to Fine Basis}
