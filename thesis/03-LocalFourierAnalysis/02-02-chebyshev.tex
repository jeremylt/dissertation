...
However, for $\nu \geq 2$ sequential applications of the preconditioner, such as in multiple smoothing passes for a multigrid cycle, the Jacobi smoother is a degree $\nu$ polynomial that is not minimal on this interval.
...
It is well known that polynomial smoothers allow more aggressive coarsening than Jacobi \cite{brannick2015polynomial}, although this will not prove sufficient for our aggressive coarsening directly to linear elements.
