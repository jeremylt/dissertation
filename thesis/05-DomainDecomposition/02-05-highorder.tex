...
\end{tabular}
\end{center}
\caption{Condition Numbers and Maximal Eigenvalues for BDDC with Single High-Order Element Subdomains for Scalar Laplacian in 2D}
...
\begin{figure}[!ht]
  ...
  \caption{Low-Order and High-Order Subdomain BDDC Condition Number Comparison for Scalar Laplacian in 2D}
\end{figure}
...
\begin{figure}[!ht]
  ...
  \caption{Low-Order and High-Order Subdomain Dirichlet BDDC Condition Number Bounds for 2D Laplacian}
...
\end{tabular}
\end{center}
\caption{Condition Numbers and Maximal Eigenvalues for Dirichlet BDDC with Single Element High-Order Subdomains for 2D Laplacian}
...
\end{tabular}
\end{center}
\caption{Condition Numbers and Maximal Eigenvalues for Dirichlet BDDC 4 Element High-Order Subdomains for 2D Laplacian}
