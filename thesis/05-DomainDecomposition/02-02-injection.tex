...
$\mathbf{P}_\pi$ is a permutation matrix that re-orders the Fourier modes to agree with the order given for high-order operators in Definition \ref{def:high_order_symbol}.
