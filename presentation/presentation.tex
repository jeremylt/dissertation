...
Domain Decomposition Diagram Goes Here\\
...
\end{table}
Condition numbers and maximal eigenvalues for low-order macro-elements\\
...
\end{table}
Condition numbers and maximal eigenvalues for single high-order element subdomains\\
