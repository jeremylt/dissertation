...
The weak form of the screened Poisson equation is given by $\int_\Omega \nabla v : \nabla u - \alpha^2 v \cdot u = \int_\Omega f$, and therefore this equation can be represented in the form in Equation \ref{eq:weak_form} with a Galerkin system given by Equation \ref{eq:galerkin_form}.
